...
handles, labels = axs[0,0].get_legend_handles_labels()
lgdord = [0,1,2,3]
fig.legend([handles[i] for i in lgdord], [labels[i] for i in lgdord], loc='upper center', bbox_to_anchor=(0.5,0.95), ncol=4, mode='None', borderaxespad=0, fontsize=12)
saveDir = '/scratch/projects/deepwind/photo/coherence'
saveName = 'co-coh_av_ver_gp.png'
plt.savefig(saveDir + '/' + saveName, bbox_inches='tight')
plt.show()



""" 2*3 plots of quad-coh_av """
fig = plt.figure()
fig.set_figwidth(10)
fig.set_figheight(6)
rNum, cNum = (2,3)
...
fig.legend([handles[i] for i in lgdord], [labels[i] for i in lgdord], loc='upper center', bbox_to_anchor=(0.5,0.95), ncol=4, mode='None', borderaxespad=0, fontsize=12)
saveDir = '/scratch/projects/deepwind/photo/coherence'
saveName = 'quad-coh_av_ver_gp.png'
plt.savefig(saveDir + '/' + saveName, bbox_inches='tight')
plt.show()
...
axs[0,0].text(0.5, 0.5*np.pi, r"$\mathrm{h = 60m}$", fontsize=12) # transform=axs[0,0].transAxes
...
axs[0,1].text(0.5, 0.5*np.pi, r"$\mathrm{h = 60m}$", fontsize=12) # transform=axs[0,0].transAxes
...
axs[0,2].text(0.5, 0.5*np.pi, r"$\mathrm{h = 60m}$", fontsize=12) # transform=axs[0,0].transAxes
...
axs[1,0].text(0.5, 0.5*np.pi, r"$\mathrm{h = 140m}$", fontsize=12) # transform=axs[0,0].transAxes
...
axs[1,1].text(0.5, 0.5*np.pi, r"$\mathrm{h = 140m}$", fontsize=12) # transform=axs[0,0].transAxes
...
axs[1,2].text(0.5, 0.5*np.pi, r"$\mathrm{h = 140m}$", fontsize=12) # transform=axs[0,0].transAxes
