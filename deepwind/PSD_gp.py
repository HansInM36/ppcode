...
tSeq_5, xSeq_5, ySeq_5, zSeq_5, vSeq_5 = getData_palm(dir_5, jobName, 'M03', ['.001'], 'v')
tSeq_5, xSeq_5, ySeq_5, zSeq_5, wSeq_5 = getData_palm(dir_5, jobName, 'M03', ['.001'], 'w')
...
# kaimal spectrum
f_seq_kaimal = np.linspace(1e-6,1e2,2000)
