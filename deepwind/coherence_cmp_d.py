...
# calculate coherence
p0Ind = 24
t_seq_0, u0_0, u1_0, freq_0, coh_0, co_coh_0, phase_0 = coh_sowfa((0,p0Ind,4), (0,p0Ind+2,4), xSeq_0.size, ySeq_0.size, (144000.0, 146400, 0.1), tSeq_0, varSeq_0, 240)
t_seq_1, u0_1, u1_1, freq_1, coh_1, co_coh_1, phase_1 = coh_sowfa((0,p0Ind,4), (0,p0Ind+4,4), xSeq_0.size, ySeq_0.size, (144000.0, 146400, 0.1), tSeq_0, varSeq_0, 240)
...
# calculate coherence
p0Ind = 32
t_seq_2, u0_2, u1_2, freq_2, coh_2, co_coh_2, phase_2 = coh_palm((0,p0Ind,4), (0,p0Ind+2,4), (72000.0, 74400, 0.1), tSeq_1, varSeq_1, 240)
t_seq_3, u0_3, u1_3, freq_3, coh_3, co_coh_3, phase_3 = coh_palm((0,p0Ind,4), (0,p0Ind+4,4), (72000.0, 74400, 0.1), tSeq_1, varSeq_1, 240)
...
# calculate coherence
p0Ind = 32
t_seq_4, u0_4, u1_4, freq_4, coh_4, co_coh_4, phase_4 = coh_palm((0,p0Ind,4), (0,p0Ind+2,4), (74400.0, 81600, 0.5), tSeq_1, varSeq_1, 240)
t_seq_5, u0_5, u1_5, freq_5, coh_5, co_coh_5, phase_5 = coh_palm((0,p0Ind,4), (0,p0Ind+4,4), (74400.0, 81600, 0.5), tSeq_1, varSeq_1, 240)



# plot coherence
fig, ax = plt.subplots(figsize=(8,4))
ax.plot(freq_0[0:], coh_0[0:], linestyle='-', marker='o', markersize=5, color='r', label='SOWFA-40m')
ax.plot(freq_1[0:], coh_1[0:], linestyle='-', marker='o', markersize=5, color='b', label='SOWFA-80m')
ax.plot(freq_2[0:], coh_2[0:], linestyle='--', marker='^', markersize=5, color='r', label='PALM-40m')
ax.plot(freq_3[0:], coh_3[0:], linestyle='--', marker='^', markersize=5, color='b', label='PALM-80m')
ax.plot(freq_4[0:], coh_4[0:], linestyle=':', marker='^', markersize=5, color='r', label='PALM-40m-LT')
ax.plot(freq_5[0:], coh_5[0:], linestyle=':', marker='^', markersize=5, color='b', label='PALM-80m-LT')
...
saveName = 'co-coh_cmp_d_sowfa_palm.png'
