...
"""
plot averaged co_coherence to investigate the effect of separation (SOWFA and PALM)
"""
### sowfa
...
tSeq_0, xSeq_0, ySeq_0, zSeq_0, varSeq_0, coors_0 = getData_sowfa(dir_0, 'prbg1', ((0,0,0),30.0), 'U', 0)
# averaged coherence
...
freq_1, coh_av_1, coh_std_1, co_coh_av_1, co_coh_std_1, phase_av_1, phase_std_1 = coh_av_sowfa_y(0, 0, 50, 4, 4, xSeq_0.size, ySeq_0.size, (144000.0, 146400, 0.1), tSeq_0, varSeq_0, 240)

### palm
prjDir = '/scratch/palmdata/JOBS'
jobName  = 'deepwind_gs5'
dir_1 = prjDir + '/' + jobName
tSeq_1, xSeq_1, ySeq_1, zSeq_1, varSeq_1 = getData_palm(dir_1, jobName, 'M04', ['.011','.012','.013','.014'], 'u')
# averaged coherence
freq_2, coh_av_2, coh_std_2, co_coh_av_2, co_coh_std_2, phase_av_2, phase_std_2 = coh_av_palm_y(0, 0, 50, 2, 4, (72000.0, 74400, 0.1), tSeq_1, varSeq_1, 240)
freq_3, coh_av_3, coh_std_3, co_coh_av_3, co_coh_std_3, phase_av_3, phase_std_3 = coh_av_palm_y(0, 0, 50, 4, 4, (72000.0, 74400, 0.1), tSeq_1, varSeq_1, 240)

### palm
prjDir = '/scratch/palmdata/JOBS'
jobName  = 'deepwind_gs5_mdf'
dir_1 = prjDir + '/' + jobName
tSeq_1, xSeq_1, ySeq_1, zSeq_1, varSeq_1 = getData_palm(dir_1, jobName, 'M04', ['.003','.004'], 'u')
# averaged coherence
freq_4, coh_av_4, coh_std_4, co_coh_av_4, co_coh_std_4, phase_av_4, phase_std_4 = coh_av_palm_y(0, 0, 50, 2, 4, (74400.0, 81600, 0.5), tSeq_1, varSeq_1, 240)
freq_5, coh_av_5, coh_std_5, co_coh_av_5, co_coh_std_5, phase_av_5, phase_std_5 = coh_av_palm_y(0, 0, 50, 4, 4, (74400.0, 81600, 0.5), tSeq_1, varSeq_1, 240)



# plot co-coherence
fig, ax = plt.subplots(figsize=(8,4))
ax.plot(freq_0[0:], co_coh_av_0[0:], linestyle='-', marker='o', markersize=5, color='r', label='SOWFA-40m')
ax.plot(freq_1[0:], co_coh_av_1[0:], linestyle='-', marker='o', markersize=5, color='b', label='SOWFA-80m')
ax.plot(freq_2[0:], co_coh_av_2[0:], linestyle='--', marker='^', markersize=5, color='r', label='PALM-40m')
ax.plot(freq_3[0:], co_coh_av_3[0:], linestyle='--', marker='^', markersize=5, color='b', label='PALM-80m')
# ax.plot(freq_4[0:], co_coh_av_4[0:], linestyle=':', marker='^', markersize=5, color='r', label='PALM-40m-LT')
# ax.plot(freq_5[0:], co_coh_av_5[0:], linestyle=':', marker='^', markersize=5, color='b', label='PALM-80m-LT')
...
plt.legend(bbox_to_anchor=(0.76,0.8), loc=6, borderaxespad=0, fontsize=10) # (1.05,0.5) is the relative position of legend to the origin, loc is the reference point of the legend
ax.grid()
plt.title('')
fig.tight_layout() # adjust the layout
# saveName = 'co-coh_av_cmp_d_sowfa_palm.png'
# plt.savefig('/scratch/projects/deepwind/photo/15.01.2021' + '/' + saveName)
plt.show()
plt.close()
...
# plot phase
fig, ax = plt.subplots(figsize=(8,4))
ax.plot(freq_0[0:], phase_av_0[0:], linestyle='-', marker='o', markersize=5, color='r', label='SOWFA-40m')
ax.plot(freq_1[0:], phase_av_1[0:], linestyle='-', marker='o', markersize=5, color='b', label='SOWFA-80m')
ax.plot(freq_2[0:], phase_av_2[0:], linestyle='--', marker='^', markersize=5, color='r', label='PALM-40m')
ax.plot(freq_3[0:], phase_av_3[0:], linestyle='--', marker='^', markersize=5, color='b', label='PALM-80m')
...
plt.title('')
fig.tight_layout() # adjust the layout
saveName = 'phase_av_cmp_d_sowfa_palm.png'
plt.savefig('/scratch/projects/deepwind/photo/15.01.2021' + '/' + saveName)
plt.show()
plt.close()
...
# # plot phase
# fig, ax = plt.subplots(figsize=(8,4))
# ax.plot(freq_0[0:], co_coh_av_0[0:]/np.cos(phase_av_0[0:]), linestyle='-', marker='o', markersize=5, color='r', label='SOWFA-40m')
# ax.plot(freq_1[0:], co_coh_av_1[0:]/np.cos(phase_av_1[0:]), linestyle='-', marker='o', markersize=5, color='b', label='SOWFA-80m')
# ax.plot(freq_2[0:], co_coh_av_2[0:]/np.cos(phase_av_2[0:]), linestyle='--', marker='^', markersize=5, color='r', label='PALM-40m')
# ax.plot(freq_3[0:], co_coh_av_3[0:]/np.cos(phase_av_3[0:]), linestyle='--', marker='^', markersize=5, color='b', label='PALM-80m')
#
# ax.set_xlabel('f (1/s)', fontsize=12)
...
# plt.title('')
# fig.tight_layout() # adjust the layout
# saveName = 'coh_av_cmp_d_sowfa_palm.png'
# plt.savefig('/scratch/projects/deepwind/photo/15.01.2021' + '/' + saveName)
# plt.show()
# plt.close()
