...
def coh(p0_id, p1_id, t_para, tSeq, varSeq):
    t_start = t_para[0]
    t_end = t_para[1]
    t_delta = t_para[2]
...
### plot coherence of multi cases at a certain height

jobName_0 = 'gs10'
ppDir_0 = '/scratch/sowfadata/pp/' + prjName + '/' + jobName_0
tSeq_0, xSeq_0, ySeq_0, zSeq_0, varSeq_0, coors_0 = velo_prb(ppDir_0, 'prbg0', ((0,0,0),30.0), 'U', 0)

jobName_1 = 'gs10_stdsgs'
ppDir_1 = '/scratch/sowfadata/pp/' + prjName + '/' + jobName_1
tSeq_1, xSeq_1, ySeq_1, zSeq_1, varSeq_1, coors_1 = velo_prb(ppDir_1, 'prbg0', ((0,0,0),30.0), 'U', 0)

# because the parameters below are identical for every case, so we use those of case 0
xNum = xSeq_0.size
yNum = ySeq_0.size
zNum = zSeq_0.size
...
yInds = (0,0,0,0)
xInds = (0,0,4,8)
pIDs = [zInds[p]*xNum*yNum + yInds[p]*xNum + xInds[p] for p in range(spNum)]

# calculate coherence
t_seq_0, u0_0, u1_0, freq, coh_0, co_coh_0, phase_0 = coh(pIDs[0], pIDs[1], (144000.0, 146400, 0.1), tSeq_0, varSeq_0)
t_seq_1, u0_1, u1_1, freq, coh_1, co_coh_1, phase_1 = coh(pIDs[0], pIDs[1], (43200.0, 45600, 0.1), tSeq_1, varSeq_1)
...
ax.plot(freq[1:], coh_0[1:], linestyle='', marker='o', markersize=1, color='r', label='oneEquation')
...
ax.plot(freq[1:], coh_1[1:], linestyle='', marker='o', markersize=1, color='b', label='standard')
...
""" plot co-coherence """
fig, ax = plt.subplots(figsize=(6,4))
ax.plot(freq[1:], co_coh_0[1:], linestyle='', marker='o', markersize=1, color='r', label='oneEquation')
ax.plot(freq[1:], co_coh_1[1:], linestyle='', marker='o', markersize=1, color='b', label='standard')
...
""" plot phase """
fig, ax = plt.subplots(figsize=(6,4))
ax.plot(freq[1:], phase_0[1:], linestyle='', marker='o', markersize=1, color='r', label='oneEquation')
ax.plot(freq[1:], phase_1[1:], linestyle='', marker='o', markersize=1, color='b', label='standard')
...
p1_id = zInd * xNum * yNum + 2
p2_id = zInd * xNum * yNum + 4
p3_id = zInd * xNum * yNum + 6
