...
# choose point id
p0_id = zInd0 * xNum * yNum
p1_id = zInd1 * xNum * yNum
p2_id = zInd2 * xNum * yNum
p3_id = zInd3 * xNum * yNum
...
ax.plot(freq[1:], coh01[1:], linestyle='', marker='o', markersize=1, color='r', label='d = 50m')
...
# dx = 80m
ax.plot(freq[1:], coh02[1:], linestyle='', marker='o', markersize=1, color='b', label='d = 100m')
...
ax.plot(freq[0:ind_out], fitting_func(freq[0:ind_out], *popt), linestyle='-', color='b',
     label='a=%5.3f, alpha=%5.3f' % tuple(popt))
# dx = 120m
ax.plot(freq[1:], coh03[1:], linestyle='', marker='o', markersize=1, color='g', label='d = 150m')
...
saveName = 'uu_coh_ver' + '_' + str(int(zSeq[zInd])) + '_pr.png'
plt.savefig(ppDir + '/' + saveName)
plt.show()
...
""" plot co-coherence """
fig, ax = plt.subplots(figsize=(6,4))
ax.plot(freq[1:], co_coh01[1:], linestyle='', marker='o', markersize=1, color='r', label='d = 50m')
ax.plot(freq[1:], co_coh02[1:], linestyle='', marker='o', markersize=1, color='b', label='d = 100m')
ax.plot(freq[1:], co_coh03[1:], linestyle='', marker='o', markersize=1, color='g', label='d = 150m')
...
plt.title('')
fig.tight_layout() # adjust the layout
saveName = 'uu_cocoh_ver' + '_' + str(int(zSeq[zInd])) + '_pr.png'
plt.savefig(ppDir + '/' + saveName)
plt.show()
...
""" plot phase """
fig, ax = plt.subplots(figsize=(6,4))
ax.plot(freq[1:], phase01[1:], linestyle='', marker='o', markersize=1, color='r', label='d = 50m')
ax.plot(freq[1:], phase02[1:], linestyle='', marker='o', markersize=1, color='b', label='d = 100m')
ax.plot(freq[1:], phase03[1:], linestyle='', marker='o', markersize=1, color='g', label='d = 150m')
...
plt.title('')
fig.tight_layout() # adjust the layout
saveName = 'uu_phase_ver' + '_' + str(int(zSeq[zInd])) + '_pr.png'
plt.savefig(ppDir + '/' + saveName)
plt.show()
