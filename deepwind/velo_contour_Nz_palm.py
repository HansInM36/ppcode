...
tInd_start, tInd_end = 0, 600
xInd_start, xInd_end = 0, -1 # 39, 90
yInd_start, yInd_end = 0, -1 # 39, 90
...
for i in range(cycle_num):
    ...
    varSeq_list.append(np.array(nc_file_list[i].variables[varName][tInd_start:tInd_end,:,yInd_start:yInd_end,xInd_start:xInd_end], dtype=type(nc_file_list[i].variables[varName])))
