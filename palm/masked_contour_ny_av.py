...
for i in range(cycle_num):
    input_file = "/scratch/palmdata/JOBS/" + jobname + "/OUTPUT/" + jobname + "_av_masked_" + maskid + cycle_no_list[i] + ".nc"
...
clb = axs.contourf(xseq, zseq, varseq[tind,:,yind,:], cbreso, levels=levels, cmap='coolwarm', vmin=vmin, vmax=vmax)
...
saveName = varname + '_contour_ny_av_' + str(plotNo) + '.png'
