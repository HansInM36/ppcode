...
tSeq_4, zSeq_4, rsvSeq_4, sgsSeq_4, totSeq_4 = uwflux_palm(ppDir, ['.001','.002'])
totSeq_4 = totSeq_4[-1]
# totSeq_4 = uwflux_plot_palm(totSeq_4, tSeq_4, zSeq_4.size, 79200.0)

jobName  = 'deepwind_gs20_main_nodis'
ppDir = '/scratch/palmdata/pp/' + jobName
tSeq_5, zSeq_5, rsvSeq_5, sgsSeq_5, totSeq_5 = uwflux_palm(ppDir, ['.000'])
totSeq_5 = totSeq_5[-1]
...
plt.plot(totSeq_4[:cflInd_palm], zSeq_4[:cflInd_palm], label='pcr', linestyle='--', linewidth=1.0, color='b')
plt.plot(totSeq_5[:cflInd_palm], zSeq_5[:cflInd_palm], label='main', linestyle='--', linewidth=1.0, color='g')
