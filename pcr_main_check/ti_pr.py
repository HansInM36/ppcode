...
prjDir = '/scratch/palmdata/JOBS'
jobName_4  = 'deepwind_gs20'
dir_4 = prjDir + '/' + jobName_4
tSeq_4, zSeq_4, TIuSeq_4, TIvSeq_4, TIwSeq_4 = TI_pr_palm(dir_4, jobName_4, ['.001', '.002']) # ['.000','.001']
TIuSeq_4, TIvSeq_4, TIwSeq_4 = TIuSeq_4[-2], TIvSeq_4[-2], TIwSeq_4[-2]


prjDir = '/scratch/palmdata/JOBS'
jobName_5  = 'deepwind_gs20_main_nodis'
dir_5 = prjDir + '/' + jobName_5
tSeq_5, zSeq_5, TIuSeq_5, TIvSeq_5, TIwSeq_5 = TI_pr_palm(dir_5, jobName_5, ['.000']) # ['.000','.001']
