...
Sf_0 = PSD_palm((0.0, 43200.0, 0.5), data_0[0], 40, data_0[1].size, data_0[2].size, data_0[4], 20480)

prjDir = '/scratch/palmdata/JOBS'
jobName  = 'WRFPALM_20150701_nostg'
dir = prjDir + '/' + jobName
data_1 = getData_palm(dir, jobName, 'M05', ['.000','.001','.002','.003'], 'u')
Sf_1 = PSD_palm((0.0, 43200.0, 0.5), data_1[0], 40, data_1[1].size, data_1[2].size, data_1[4], 20480)
...
dn = 1
plt.loglog(Sf_0[0][0::dn], Sf_0[1][0::dn], label='ref', linewidth=1.0, linestyle='-', color=colors[0])
plt.loglog(Sf_1[0][0::dn], Sf_1[1][0::dn], label='nostg', linewidth=1.0, linestyle='-', color=colors[1])
# -5/3 law
