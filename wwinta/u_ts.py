...
dir = prjDir + '/' + jobName
tSeq, xuSeq, yuSeq, zuSeq, uSeq = getData_palm(dir, jobName, 'M03', ['.001'], 'u')


# plot
fig, ax = plt.subplots(figsize=(12,3))

plt.plot(tSeq[:] - tSeq[0], uSeq[:,1,0,0], label='', linewidth=1.0, linestyle='-', color='k')
...
saveDir = '/scratch/projects/wwinta/photo/ts'
saveName = jobName + '_u_ts.png'
