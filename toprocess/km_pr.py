...
tSeq, zSeq, kmSeq = velo_pr_palm(jobDir, jobName, ['.000'], 'km')
...
plt.plot(kmSeq[-1], zSeq/1000, label='palm', linewidth=1.0, linestyle='-', color='k')
plt.xlabel(r"$\mathrm{K_m}$ ($\mathrm{m^2/s}$)", fontsize=12)
